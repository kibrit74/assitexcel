            ...
            <div>
              ...
              <div className=\"relative\">
                ...
                <input
                  ...
                  className=\"block w-full pl-10 pr-3 py-3 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all\"
            ...
            <div>
              ...
              <div className=\"relative\">
                ...
                <input
                  ...
                  className=\"block w-full pl-10 pr-12 py-3 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all\"
                  placeholder=\"••••••••\"
                />
                <button
                  type=\"button\"
